...
public class OwnerAddressStep extends Step<String> {

    private EditText name;

    public OwnerAddressStep(String title) {
        super(title);
    }
    ...
    protected IsDataValid isStepDataValid(String stepData) {
        ...
        String error = !isNameValid ? "Not empty address " : "";
